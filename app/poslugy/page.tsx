...
const businessProfileServices = [
  { slug: "prybyrannya-kvartyr-cherkasy", description: "Прибирання квартир у Черкасах: підтримуюче від 55 грн/м², генеральне від 100 грн/м² та післяремонтне від 100 грн/м²." },
