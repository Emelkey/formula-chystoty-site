...
export const metadata: Metadata = buildMetadata({
  ...
  description: "Відгуки клієнтів про клінінгову компанію Формула Чистоти у Черкасах. Реальні враження після прибирання квартир, будинків та комерційних об’єктів.",
  path: "/vidguky"
});
