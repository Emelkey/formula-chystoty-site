...
const priceGroups: PriceGroup[] = [
  {
    ...
    rows: [
      ...
      ["Генеральне прибирання квартири без шаф усередині", "від 100 грн/м²", serviceThumbs.apartmentGeneral, apartmentGeneralUrl],
...
const examples = [
  {
    ...
    price: "Орієнтовна вартість: від 100 грн/м² без шаф усередині або від 120 грн/м² з шафами усередині.",
...
const meterPriceGroups: PriceGroup[] = [
  ...
  },
  {
    ...
    rows: [
      ["Без миття шаф усередині", "від 100 грн/м²", serviceThumbs.apartmentGeneral, apartmentGeneralUrl],
      ["З миттям шаф усередині", "від 120 грн/м²", extraThumbs.kitchenCabinets, apartmentGeneralUrl],
...
const priceFaq: Faq[] = [
  { question: "Скільки коштує прибирання квартири у Черкасах?", answer: "Вартість залежить від площі, стану квартири, типу прибирання та додаткових робіт. Підтримуюче прибирання стартує від 55 грн/м², генеральне — від 100 грн/м² без шаф усередині або від 120 грн/м² з шафами усередині, після ремонту — від 100 грн/м²." },
