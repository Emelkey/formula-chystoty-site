  ...
  return (
    <>
      <HeroSection
        ...
        accent="у Черкасах"
        description="Клінінг у Черкасах для квартир, будинків і бізнесу: підтримуюче прибирання від 55 грн/м², генеральне від 100 грн/м², після ремонту від 120 грн/м². Розрахуємо вартість за фото."
      />
