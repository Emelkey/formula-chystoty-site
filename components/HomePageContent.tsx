  ...
  return (
    <>
      <HeroSection
        ...
        accent="у Черкасах"
        description="Формула Чистоти — клінінгова компанія у Черкасах для житла, бізнесу та складних об’єктів. Приїжджаємо командою зі своїм інвентарем, професійною хімією та погодженим планом робіт."
      />
