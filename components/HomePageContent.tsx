      ...
      <section className="bg-white pb-12">
        <div className="container">
          <div className="grid gap-5 rounded-[24px] border border-brand-green/15 bg-brand-mist p-6 shadow-soft md:grid-cols-[0.85fr_1.15fr] md:p-8">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.08em] text-brand-hover">Про клінінг</p>
            ...
            <div className="grid gap-4 leading-7 text-brand-graphite">
              ...
              <p>Команда приїжджає зі своїм інвентарем і професійною хімією. Перед початком уточнюємо стан приміщення, пріоритетні зони та додаткові роботи, щоб одразу погодити зрозумілий план прибирання.</p>
              <p>
                Під час розрахунку враховуємо площу, рівень забруднення, типи поверхонь і складність доступу. Орієнтири зібрані на сторінці{" "}
                ...
                , а точну суму повідомляємо після фото, відео або огляду об’єкта.
              </p>
              <p>
