...
const internalLinks = [
  ...
  { text: "генеральне прибирання квартири", href: "/generalne-prybyrannya-kvartyry-cherkasy" },
    ...
    <>
      ...
      <article className="section bg-white">
        <div className="container max-w-3xl">
          ...
          <h1 className="text-4xl font-bold leading-tight md:text-5xl">{post.h1 ?? post.title}</h1>
          ...
          <div className="mt-10 rounded-lg bg-brand-green p-6 text-white">
            ...
            <p className="mt-3 leading-7 text-white/85">{post.cta?.description ?? "Напишіть нам, і ми підкажемо, який формат клінінгу підійде для вашого об’єкта."}</p>
            <div className="mt-5 flex flex-wrap gap-3">
              <PrimaryButton href={post.cta?.href}>{post.cta?.buttonLabel ?? "Розрахувати вартість"}</PrimaryButton>
              <ContactButtons />
            </div>
          </div>
        </div>
