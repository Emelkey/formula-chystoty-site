...
export function ServiceCard({ service }: { service: CardService }) {
  ...
  return (
    <article className="group flex h-full min-h-[420px] flex-col overflow-hidden rounded-[24px] border border-[#E8EEE5] bg-white p-5 shadow-soft transition duration-300 hover:-translate-y-1 hover:shadow-[0_24px_70px_rgba(17,17,17,0.12)] sm:p-6">
      <div className="flex flex-1 flex-col">
        ...
        <h2 className="line-clamp-2 min-h-[3.25rem] text-xl font-bold leading-tight text-brand-black">{service.title}</h2>
