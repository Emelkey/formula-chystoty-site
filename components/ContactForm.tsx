...
const cleaningTypes = ["Генеральне прибирання", "Підтримуюче прибирання", "Після ремонту", "Прибирання після потопу", "Прибирання прилеглої території", "Прибирання квартири", "Прибирання будинку", "Прибирання офісу", "Прибирання магазину або супермаркету", "Клінінг комерційного приміщення", "Хімчистка меблів або килимів", "Миття вікон"];
