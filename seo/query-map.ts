...
const parents: Record<string, string> = {
  "/pidtrymuyuche-prybyrannya-kvartyr-cherkasy": "/prybyrannya-kvartyr-cherkasy",
  "/generalne-prybyrannya-kvartyry-cherkasy": "/prybyrannya-kvartyr-cherkasy",
  "/generalne-prybyrannya-kuhni-cherkasy": "/generalne-prybyrannya-cherkasy",
  "/himchystka-dyvana-cherkasy": "/himchystka-mebliv-cherkasy",
  "/himchystka-matratsa-cherkasy": "/himchystka-mebliv-cherkasy",
  "/himchystka-stiltsiv-cherkasy": "/himchystka-mebliv-cherkasy",
  "/himchystka-krisel-cherkasy": "/himchystka-mebliv-cherkasy"
};
function parentFor(path: string, role: SeoIntentRole): string | null {
  if (path === "/") return null;
  if (["trust", "catalog", "supporting"].includes(role) || path === "/prices") return "/";
  return parents[path] ?? "/poslugy";
}
...
const entry = (
  ...
  path,
  role,
  canonicalUrl: `https://www.formula-chistoty.ck.ua${path}`,
  hubParent: parentFor(path, role),
  primaryIntent,
  secondaryIntents,
  forbiddenIntents,
  supportingUrls,
...
export const queryMap: SeoIntentEntry[] = [
  entry(
    "/",
    "primary",
    "клінінг Черкаси",
    ...
    ["клінінгова компанія Черкаси", "професійний клінінг Черкаси", "клининг Черкассы"],
  ...
  entry(
    ...
    ["вартість прибирання Черкаси", "прайс клінінгу", "клінінг ціни", "клінінг Черкаси ціна"],
  ...
  entry("/generalne-prybyrannya-cherkasy", "primary", "генеральне прибирання Черкаси", "Генеральне прибирання приміщень у Черкасах | Формула Чистоти", "Генеральне прибирання приміщень у Черкасах", ["генеральний клінінг Черкаси", "генеральне прибирання приміщень Черкаси"], ["генеральне прибирання квартири Черкаси", "генеральне прибирання кухні Черкаси"], ["/blog/generalne-ta-pidtrymuyuche-prybyrannya-riznytsya"], ["/generalne-prybyrannya-kvartyry-cherkasy", "/generalne-prybyrannya-kuhni-cherkasy"]),
...
export const queryMapPaths = new Set(queryMap.map((item) => item.path));
