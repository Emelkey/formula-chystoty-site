...
const legacyRedirects = [
  ...
  { source: "/uk/services/prybyrannya-torgovyh-centriv", destination: "/prybyrannya-mahazyniv-supermarketiv-cherkasy", statusCode: 301 },
  { source: "/uk/services/prybyrannya-torgovykh-tsentriv", destination: "/prybyrannya-mahazyniv-supermarketiv-cherkasy", statusCode: 301 },
  { source: "/uk/services/obslugovuvannya-ta-klining-promislovih-i-virobnichih-primishhen", destination: "/prybyrannya-vyrobnychykh-prymishchen-cherkasy", statusCode: 301 },
  ...
  { source: "/uk/services/prybyrannya-skladiv", destination: "/prybyrannya-skladiv-cherkasy", statusCode: 301 },
  { source: "/ru/services/uborka-skladov", destination: "/prybyrannya-skladiv-cherkasy", statusCode: 301 },
  { source: "/uk/services/prybyrannya-medychnykh-tsentriv", destination: "/prybyrannya-medychnykh-tsentriv-cherkasy", statusCode: 301 },
  { source: "/ru/services/uborka-meditsinskih-centrov", destination: "/prybyrannya-medychnykh-tsentriv-cherkasy", statusCode: 301 },
  { source: "/uk/services/himchystka-stiltsiv", destination: "/himchystka-stiltsiv-cherkasy", statusCode: 301 },
  { source: "/ru/services/himchistka-stulev", destination: "/himchystka-stiltsiv-cherkasy", statusCode: 301 },
  { source: "/uk/services/himchystka-krisel", destination: "/himchystka-krisel-cherkasy", statusCode: 301 },
  { source: "/ru/services/himchistka-kresel", destination: "/himchystka-krisel-cherkasy", statusCode: 301 },
  { source: "/uk/services/himchystka-kovrolinu", destination: "/himchystka-kovrolinu-cherkasy", statusCode: 301 },
  ...
  { source: "/uk/contact", destination: "/kontakty", statusCode: 301 },
  ...
  { source: "/uk/about", destination: "/pro-nas", statusCode: 301 },
  ...
  { source: "/uk/prices", destination: "/prices", statusCode: 301 },
